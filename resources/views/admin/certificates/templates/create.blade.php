    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                <form action="{{ route('admin.certificates.templates.store') }}" method="POST" class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <input type="text" name="title" required placeholder="e.g. SCHOOL LEAVING CERTIFICATE" class="w-full rounded-xl border-gray-300 focus:ring-blue-500 focus:border-blue-500">
                        <p class="text-xs text-gray-500 mt-1">Bold header at the top of the certificate.</p>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Body Content</label>
                        <textarea name="body" rows="10" required class="w-full rounded-xl border-gray-300 focus:ring-blue-500 focus:border-blue-500 font-mono text-sm" placeholder="This is to certify that {{student_name}} of class {{class}}..."></textarea>
                    </div>

                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Footer Left (Signature)</label>
                            <input type="text" name="footer_left" placeholder="Principal Signature" class="w-full rounded-xl border-gray-300 focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Footer Right (Date/Stamp)</label>
                            <input type="text" name="footer_right" placeholder="Date of Issue" class="w-full rounded-xl border-gray-300 focus:ring-blue-500 focus:border-blue-500">
                        </div>
                    </div>
                    ...
                    <div class="pt-4 border-t border-gray-100 flex justify-end gap-3">
                        ...
                        <button type="submit" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 shadow-lg shadow-blue-600/20 transition-all">Save Template</button>
                    </div>
                </form>
            </div>
