...
<div class="max-w-2xl mx-auto space-y-6">
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Add New Accountant</h1>
            <p class="text-gray-500 text-sm mt-1">Create a new account for school accountant</p>
        </div>
    </div>

    <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
        <form action="{{ route('admin.accountants.store') }}" method="POST" class="space-y-6">
            @csrf
