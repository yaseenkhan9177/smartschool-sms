...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto mb-6 flex justify-between items-center print:hidden">
        <a href="{{ route('accountant.certificates.index') }}" class="text-gray-500 hover:text-gray-700 flex items-center gap-2">
    ...
    <!-- Certificate Container (Reused Styles from Admin) -->
