                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-right">
                            <a href="{{ route('accountant.certificates.show', $cert->id) }}" target="_blank" class="text-indigo-600 hover:text-indigo-900 font-medium text-xs flex items-center justify-end gap-1">
