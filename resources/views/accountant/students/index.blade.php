...
<div x-data="{ reportModal: false, passwordModal: false, selectedStudent: { id: '', name: '' } }" class="space-y-6">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex gap-2">
            <a href="{{ route('accountant.students.import') }}" class="px-4 py-2 bg-emerald-600 text-white rounded-lg text-sm font-medium hover:bg-emerald-700 shadow-lg shadow-emerald-600/20 transition-all flex items-center gap-2">
